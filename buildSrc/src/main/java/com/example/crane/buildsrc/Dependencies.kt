...
object Libs {
    ...
    object AndroidX {
        object Compose {
            ...
            const val runtimeLivedata = "androidx.compose.runtime:runtime-livedata:1.0.0-alpha10"
            const val material = "androidx.compose.material:material:1.0.0-alpha10"
            const val foundation = "androidx.compose.foundation:foundation:$version"
            const val layout = "androidx.compose.foundation:foundation-layout:$version"
            const val tooling = "androidx.compose.ui:ui-tooling:1.0.0-alpha10"
